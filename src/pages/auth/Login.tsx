...
import { Mail, Lock, ArrowRight, Globe, Share2 } from 'lucide-react';
      ...
      <Card className="w-full max-w-md p-10 rounded-[3rem] border-none bg-white/40 backdrop-blur-3xl shadow-[0_40px_100px_rgba(0,0,0,0.04)] relative z-10">
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <div className="relative group">
              ...
              <Input 
                ...
                className="h-14 pl-12 rounded-2xl bg-surface-container-low border-none placeholder:text-outline focus:ring-2 focus:ring-primary/10 transition-all outline-none"
                value={email}
          ...
          <div className="flex justify-end">
            <button className="text-xs font-bold text-primary uppercase tracking-widest hover:underline active:scale-95 transition-all">Forgot Password?</button>
          </div>
          ...
          <p className="text-center text-sm text-on-surface-variant font-medium pt-6">
            New to CareHive? {' '}
